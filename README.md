...
* DNS using Unbound + Pi‑hole on `lo` with metrics exported to Grafana
* Secure reverse proxy via Caddy combined with CrowdSec + Firewall‑Bouncer, with metrics exported to Grafana
...
_All work is exploratory, built with an emphasis on resilience and modular structure._
